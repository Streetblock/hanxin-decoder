...
Ein stichprobenartiger Vergleich gerenderter proprietary third-party-Symbole zeigte bei Version
9 vollständige Übereinstimmung. Bei Version 11 enthielten einzelne erwartete
helle Begleitpositionen dagegen nutzlastabhängige dunkle Werte. Die festen
dunklen Module stimmten überein. Das Verhalten spricht dafür, dass proprietary third-party an
diesen Positionen Daten platziert und die helle Begleitlinie nicht vollständig
reserviert.
...
proprietary third-party bleibt ein Interoperabilitätsorakel, überstimmt aber keine normative
Vorgabe.
